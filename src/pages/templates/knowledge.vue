...
interface EcoTip { title: string, desc: string, icon: any }
...
interface Policy { title: string, date: string, desc: string }
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-gray-500 mt-1 text-sm">
              学习垃圾分类指南、环保小贴士与政策法规，提升环保意识与行动力
            </p>
          </div>
        </div>
      </div>
      ...
      <el-tabs v-model="activeTab" type="border-card" class="rounded-xl overflow-hidden">
        ...
        <el-tab-pane label="分类指南" name="guide">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div class="flex items-center gap-4">
                <div
                  class="rounded-full w-14 h-14 flex items-center justify-center flex-shrink-0 shadow-sm"
                  :class="cat.color"
                >
                  <el-icon class="text-3xl">
              ...
              <div class="mt-4 border-t pt-4">
                ...
                <p class="text-gray-700 mt-1 leading-6">
                  {{ cat.tip }}
                </p>
              </div>
            </article>
        ...
        <el-tab-pane label="环保小贴士" name="tips">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <article
              v-for="(t, idx) in ecoTips" :key="idx"
            ...
            >
              ...
              <p class="text-gray-700 mt-3 leading-6">
                {{ t.desc }}
              </p>
            </article>
          </div>
        ...
        <el-tab-pane label="政策法规" name="policy">
          <div class="space-y-4">
            <article
              v-for="(p, idx) in policies" :key="idx"
              class="rounded-xl border border-gray-100/60 bg-white/80 backdrop-blur p-5 shadow-sm hover:shadow-md transition-shadow"
            >
              <div class="flex items-center gap-3">
                <div
