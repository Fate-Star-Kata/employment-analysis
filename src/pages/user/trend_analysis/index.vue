  ...
  <div class="min-h-screen bg-base-100 text-base-content">
    ...
    <div class="container mx-auto px-4 py-8 space-y-8">
      ...
      <RevealMotion :delay="0.5">
        <div class="card bg-base-200 shadow-sm">
          <div class="card-body p-6">
            <h2 class="card-title text-xl mb-6">🔥 热门职位排行</h2>
      ...
      <RevealMotion :delay="0.6">
        <div class="card bg-base-200 shadow-sm">
          <div class="card-body p-6">
            <h2 class="card-title text-xl mb-6">🛠️ 技能需求分析</h2>
            
            <div class="space-y-6">
              <div>
                <h3 class="text-lg font-semibold mb-3">技术技能</h3>
              ...
              <div>
                <h3 class="text-lg font-semibold mb-3">软技能</h3>
                <div class="flex flex-wrap gap-2">
                  <div 
      ...
      <RevealMotion :delay="0.7">
        <div class="card bg-base-200 shadow-sm">
          <div class="card-body p-6">
            <h2 class="card-title text-xl mb-6">🌍 地区就业分析</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                <div class="card-body p-4">
                  <h4 class="card-title text-lg">{{ region.city }}</h4>
