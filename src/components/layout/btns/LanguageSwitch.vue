...
<template>
  <div class="dropdown dropdown-end">
    <!-- 触发按钮 -->
    <div
      tabindex="0" role="button" class="btn btn-sm btn-ghost gap-1 px-1.5 text-[.5625rem] font-bold"
    ...
    >
      ...
      <!-- 下拉箭头 -->
      <svg
        class="mt-px hidden size-2 fill-current opacity-60 sm:inline-block" xmlns="http://www.w3.org/2000/svg"
